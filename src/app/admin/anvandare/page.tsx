...
export default async function AdminUsersPage() {
  ...
  const roleLabels: Record<string, { label: string; variant: "default" | "warning" | "danger" | "success" }> = {
      ...
      <Card padding="sm">
        <div className="relative">
          ...
          <input
            ...
            className="w-full pl-9 pr-4 py-2 text-sm rounded-lg border border-sage-200 bg-gray-50 focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-green-500"
          />
        </div>
      </Card>
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-sage-100 bg-gray-50">
                ...
                <th className="text-left px-5 py-3 font-medium text-gray-600">Nivå</th>
