...
export default async function RedigeraArtikelPage({ params }: Props) {
    ...
    <div className="space-y-6 max-w-4xl">
      <div className="flex items-center justify-between gap-3">
        <div className="flex items-center gap-3">
          ...
          <h1 className="text-2xl font-bold text-gray-900">Redigera artikel</h1>
        </div>
        {article.published && (
          <Link href={`/kunskapsbank/${article.slug}`} target="_blank"
